...
{
    public enum HatIDs {blackBandana, redBandana, blueBandana, yellowBandana, greenBandana, blackBallCap, redBallCap, yellowBallCap, greenBallCap, blueBallCap, EyePatch, halo, propBallCap, skiMask, antlers, bunnyEars, chef, cowboy, jester, leperchaun, magic, pirate, police, santa, spartan, top, viking, navy, greenMohawk, redMohawk, blueMohawk, fireHelmet, fedora, witch}
    public HatIDs hatID;
